...
enum class OpResult:ucell
{
    ...
    kUncaughtException,     // exit because of uncaught exception
    ...
    kPendingException   // exit because of a pending exception
};
...
enum class ForthError:cell
{
    ...
    undefinedWord = -13,
    interpretingCompileOnlyWord = -14,
    invalidForget = -15,
    zeroLengthName = -16,
    picturedOutputStringOverflow = -17,
    ...
    lossOfPrecision = -41,
    fpDivideByZero = -42,
    fpResultOutOfRange = -43,
    fpStackOverflow = -44,
    fpStackUnderflow = -45,
    fpInvalidArgument = -46,
    ...
    fpUnderflow = -54,
    fpUnidentifiedFault = -55,
    quit = -56,
    sendingOrReceivingCharacter = -57,
    preprocessorError = -58,
    allocate = -59,
    free = -60,
    resize = -61,
    closeFile = -62,
    ...
    // codes from -256 to -4095 are available for system to assign
    invalidParameter = -256,
    illegalOperation = -257,
    badReferenceCount = -258,
    invalidType = -259,
    badArrayIndex = -260,
    badVarOperation = -261,
    exceptionInFinally = -262,
    badSyntax = -263,
    unimplementedMethod = -264,
    badOpcode = -265,
    badOpcodeType = -266,
    missingSize = -267,
    genericUserError = -268,
    badBlockNumber = -269,
    unknownType = -270,
    brokenObject = -271,
    shellStackUnderflow = -272,
    shellStackOverflow = -273,
    structError = -274,
    illegalMethod = -275,
    stringOverflow = -276,
    badObject = -277,
...
struct ForthExceptionFrame
{
    ...
    cell*                   pSavedFP;
    ForthError              exceptionNumber;
    ExceptionState          exceptionState;
    ucell                   inputStackDepth;
};
...
// ANSI 2012 exception definitions
enum class throwCode : int32_t
{
    abort = -1,
    abortQuote = -2,
    stackOverflow = -3,
