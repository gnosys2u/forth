...
namespace OList
{
	...
	*/
	...
	FORTHOP(oListIterNew)
	{
		...
		pEngine->SetError(ForthError::illegalOperation, " cannot explicitly create a ListIter object");
	}
	...
	{
		ClassVocabulary* pListVoc = pOuter->AddBuiltinClass("List", kBCIList, kBCIIterable, oListMembers);
